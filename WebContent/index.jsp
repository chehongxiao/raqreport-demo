...
<script type="text/javascript">
    ...
    function show(name){
		...
		reportName=name;
	   document.getElementById("report").src = encodeURI("/reportJsp/showReport.jsp?rpx="+name); 
	   showLoading();
	}
    function readme(){
		document.getElementById("report").src = encodeURI("/reportJsp/showReport.jsp?rpx=/search/readme.rpx&search="+reportName); 
	}
